...
paragraph.textContent="Click on some button below to display the data you want from the JSON if you data from 1-9 press 1 ., 10-19 press 2.. similary for all datas till 100";
paragraph.id="para";
paragraph.setAttribute("class","paragraph");

divtop.append(paragraph);

let divbot=document.createElement("div");
divbot.setAttribute("class","botdiv");
divbot.id="topb";


var createbutton=(idname,classname)=>{
let btn=document.createElement("button");
btn.textContent=idname;
btn.id=idname;
...
divbot.append(createbutton("First","fst"));
//  in this first one points to idname/buttomtextinside and the second one points to the classname.
divbot.append(createbutton("Second","scnd"));
divbot.append(createbutton("Third","thrd"));
divbot.append(createbutton("Fourth","fth"));
divbot.append(createbutton("Fifth","fft"));
divbot.append(createbutton("Sixth","sxt"));
divbot.append(createbutton("Seventh","st"));
divbot.append(createbutton("Eight","et"));
divbot.append(createbutton("Nine","nt"));
divbot.append(createbutton("Ten","tt"));


var section=document.getElementById("section");
section.append(divtop,divbot);
...
var data=[
  ...
  var displaydata=(a,b)=>{
    ...
    for (let index = parseInt(a); index <parseInt(b); index++) {
      todispcont+= (index+1)+". The id of person   is  "+JSON.stringify(data[index].id)+" . ";
        // console.log("data1");
      todispcont+= "The name of person    is "+JSON.stringify(data[index].name)+" . ";
      todispcont+= "The email of person   is "+JSON.stringify(data[index].email)+" .     ";
      document.getElementById("para").innerHTML = "<p style='font-size:22px'>"+ todispcont +"</p>";
        
    }
    // document.getElementById("para").innerHTML=  "<style: font-size:40px>" + todispcont + "</style>" +  "</br>";
    }
  }

var one=document.getElementById("First");
one.addEventListener("click",displaydata("0","9"));


var two=document.getElementById("Second");
two.addEventListener("click",displaydata("10","19"));


var three=document.getElementById("Third");
three.addEventListener("click",displaydata("20","29"));


var four=document.getElementById("Fourth");
four.addEventListener("click",displaydata("30","39"));


var five=document.getElementById("Fifth");
five.addEventListener("click",displaydata("40","49"));


var six=document.getElementById("Sixth");
six.addEventListener("click",displaydata("50","59"));


var seven=document.getElementById("Seventh");
seven.addEventListener("click",displaydata("60","69"));


var eight=document.getElementById("Eight");
eight.addEventListener("click",displaydata("70","79"));


var nine=document.getElementById("Nine");
nine.addEventListener("click",displaydata("80","89"));


var ten=document.getElementById("Ten");
ten.addEventListener("click",displaydata("90","99"))